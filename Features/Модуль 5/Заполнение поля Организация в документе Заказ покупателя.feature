...
протестировать заполнение поля Организация в документе Заказ покупателя 
чтобы выполнить практическое задание 2 к Модулю 5 
...
Сценарий: Заполнение поля Организация в документе Заказ покупателя
	...
	И я делаю 2 раз
		...
		* Заполнение организации в соглашении	
