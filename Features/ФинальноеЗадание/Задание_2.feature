...
чтобы иметь достоверную информацию о том, какие товары есть на складе

Сценарий: подготовительный сценарий (загрузка документов)
* Загрузка данных
...
* Формирование отчета
	...
	И я жду, что в табличном документе 'Результат' ячейка 'R7C6' станет равна '912,00' в течение 20 секунд
