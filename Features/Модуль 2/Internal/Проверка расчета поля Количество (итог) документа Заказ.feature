...
* Проверка расчета поля Количество (итог)
	Если элемент формы с именем "ТоварыИтогКоличество" имеет значение "7" Тогда
	Иначе
	И я вызываю исключение с текстом сообщения "Неправильно рассчитано итоговое количество!"
	КонецЕсли
